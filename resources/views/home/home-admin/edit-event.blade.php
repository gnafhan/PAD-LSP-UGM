                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="tipe_event" id="tipe_event" 
                                    ...
                                    <option value="Special" {{ old('tipe_event', $event->tipe_event) == 'Special' ? 'selected' : '' }}>Special</option>
                                    <option value="Workshop" {{ old('tipe_event', $event->tipe_event) == 'Workshop' ? 'selected' : '' }}>Workshop</option>
