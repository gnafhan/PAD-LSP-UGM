            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Manajemen -->
                        <div>
                            <h4 class="font-bricolage text-lg font-semibold text-gray-900 mb-4 tracking-tight">Manajemen</h4>
                            <ul class="space-y-3">
                                <li>
                                    <a href="{{ route('admin.event.index') }}" class="text-gray-600 font-inter text-sm hover:text-sky-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 rounded">
                                        Event
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.tuk.index') }}" class="text-gray-600 font-inter text-sm hover:text-sky-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 rounded">
                                        TUK
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.skema.index') }}" class="text-gray-600 font-inter text-sm hover:text-sky-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 rounded">
                                        Skema
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.uk.index') }}" class="text-gray-600 font-inter text-sm hover:text-sky-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 rounded">
                                        Unit Kompetensi
                                    </a>
                                </li>
                            </ul>
                        ...
                        <!-- Pengguna & Asesmen -->
                        <div>
                            <h4 class="font-bricolage text-lg font-semibold text-gray-900 mb-4 tracking-tight">Pengguna & Asesmen</h4>
                            <ul class="space-y-3">
                                <li>
                                    <a href="{{ route('admin.asesi.index') }}" class="text-gray-600 font-inter text-sm hover:text-sky-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 rounded">
                                        Assign Asesor
                                    </a>
                                </li>
                                <li>
