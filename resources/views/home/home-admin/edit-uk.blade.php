                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-500 md:ml-2 font-medium">Edit Unit Kompetensi</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden max-w-3xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 py-6 px-8">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-white">Edit Unit Kompetensi</h1>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('admin.uk.update', $uk->id_uk) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="space-y-6">
                        <!-- Kode UK Field -->
                        <div>
                            ...
                            <input type="text" name="kode_uk" id="kode_uk" value="{{ $uk->kode_uk }}"
                                   ...
                                   placeholder="Contoh: KUK-01" required>
                            @error('kode_uk')
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_uk" id="nama_uk" value="{{ $uk->nama_uk }}"
                                   ...
                                   placeholder="Contoh: Pengembangan Aplikasi Web" required>
                            @error('nama_uk')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="jenis_standar" id="jenis_standar" value="{{ $uk->jenis_standar }}"
                                   ...
                                   placeholder="Contoh: Standar Nasional" required>
                            @error('jenis_standar')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                <div id="elemen-container" class="space-y-3">
                                    @if($uk->count_elemen_uk() > 0)
                                        ...
                                        <div class="flex items-center gap-2">
                                            <input type="text" name="elemen_uk[]" value="{{ $elemen->nama_elemen }}" 
                                            ...
                                            <button type="button" class="bg-red-500 text-white p-2.5 rounded-md hover:bg-red-600 transition-colors hapus-elemen {{ $uk->count_elemen_uk() <= 1 ? 'hidden' : '' }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tambahElemenBtn.addEventListener('click', function() {
            ...
            if (elemenContainer.querySelectorAll('.flex').length > 1) {
                const allDeleteBtns = elemenContainer.querySelectorAll('.hapus-elemen');
