            ...
            <div id="tandaTanganSection" class="p-4 mb-6">
                ...
                <div class="flex flex-row justify-evenly gap-6">
                    ...
                    <div class="flex flex-col items-center justify-center w-1/2">
                        ...
                        <!-- Existing signature display or message -->
                    ...
                    <div class="flex flex-col items-center justify-center w-1/2">
                        ...
                        <div id="asesorExistingSignature" class="w-60 h-40 border border-border_input rounded-lg flex items-center justify-center bg-gray-50 hidden">
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        Anda dapat mengunggah tanda tangan saat ini atau menggunakan tanda tangan yang sudah tersimpan di biodata
                    </p>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
                    ...
                    asesisData.forEach((asesi, index) => {
                        ...
                        tableContent += `
                            <tr>
                                ...
                                <td class="px-4 py-3 text-gray-700">${asesi.latest_activity}</td>
    ...
    function updateSignatureSection(detailApl02, generalInfo) {
        ...
        if (detailApl02.waktu_tanda_tangan_asesor) {
            document.getElementById('tanggalTtdAsesor').textContent = new Date(detailApl02.waktu_tanda_tangan_asesor).toLocaleDateString('id-ID');
    ...
    function saveAPL02(isSigning = false) {
        ...
        if (asesorSignatureUpload && asesorSignatureUpload.hasFile()) {
            // Use FormData if uploading signature
            const formData = new FormData();
            formData.append('id_asesi', currentAsesiId);
            formData.append('id_asesor', asesorId);
            formData.append('rekomendasi', rekomendasi);
            formData.append('metode_uji', metodeUji);
            formData.append('detail_kompetensi', JSON.stringify(detailKompetensi));
            formData.append('is_signing', isSigning);
            formData.append('tanda_tangan_asesor', asesorSignatureUpload.getFile());
