...
<div id="backFrame" class="pt-[88px] pb-80 px-4 md:px-16 bg-bg_dashboard sm:ml-64">
    <div id="judulPage" class="relative z-10 flex items-center mx-4 pb-4">
        ...
        <p class="ms-2 text-xl font-bold text-black">AK.07</p>
    </div>
    ...
    <div id="frameAK07" class="relative z-10 pt-4 p-8 border border-border bg-white rounded-2xl">
        ...
        <div id="detailAK07" class="hidden p-4 text-black">
            ...
            <div id="clPotensi" class="flex flex-row p-8 border border-border_input rounded-md">
                ...
                <div class="flex-col basis-3/4 items-center">
            ...
            <!-- Tabel 1 AK01 -->
            <div class="p-4">
                <p id="judulTabelAK07" class="text-sidebar_font font-semibold pb-2">No 1.  Kode Unit : R.93KPW00.011.2</p>
