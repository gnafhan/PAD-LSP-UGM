...
<div class="min-h-screen bg-gray-100">
    <div class="w-full bg-white p-4 shadow-md">
        <div class="flex flex-wrap gap-2">
            <a href="/persetujuan" class="bg-red-500 text-white px-2 py-1 rounded text-sm md:text-base flex-shrink-0" disabled>Assesi</a>
            ...
            <a href="/persetujuan" class="bg-red-500 text-white px-2 py-1 rounded text-sm md:text-base flex-shrink-0" disabled>FR.AK-06</a>
            <a href="/persetujuan" class="bg-red-500 text-white px-2 py-1 rounded text-sm md:text-base flex-shrink-0" disabled>FR.IA-05</a>
        </div>
    </div>
</div>
@endsection
