...
<div id="backFrame" class="pt-[88px] pb-80 px-4 md:px-16 bg-bg_dashboard sm:ml-64">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('fria03-asesor') }}" class="ms-1 text-sm font-medium text-black hover:text-sidebar_font">
                            FR.IA.03
                        </a>
                    </div>
                </li>
    ...
    <div id="frameIA03" class="relative z-10 pt-4 p-8 border border-border bg-white rounded-2xl">
        <p id="titlePage" class="mb-4 text-lg font-medium text-black">Formulir IA.02 Tugas Praktik dan Demonstrasi</p>
        <!-- Search Form -->
        <form id="searchIA03" class="max-w-md mb-4 rounded-xl">
            <div class="relative">
        ...
        <div class="overflow-x-auto shadow-sm rounded-lg">
            <table id="daftarIA03" class="min-w-full bg-white overflow-hidden">
        ...
        <div id="detailIA03" class="hidden p-4 text-black">

            <!-- Input Formulir APL.02 -->
            <div id="FRIA03" class="pt-0 p-4 space-y-6">
            ...
            <!-- Tabel 1 AK01 -->
            <div class="p-4">
                <p id="judulTabelIA03" class="text-sidebar_font font-semibold pb-2">No 1.  Kode Unit : R.93KPW00.011.2</p>
            ...
            <!-- Tabel 2 APL02 -->
            <div class="p-4">
                <p id="judulTabelIA03" class="text-sidebar_font font-semibold pb-2">No 2.  Kode Unit : R.93KPW00.011.2</p>
...
function showSummary() {
    ...
    document.getElementById('searchIA03').classList.add('hidden');

    // Sembunyikan elemen daftar asesi
    document.getElementById('daftarIA03').classList.add('hidden');

    // Tampilkan bagian breadcrumbs
    document.getElementById('breadcrumbs').classList.remove('hidden');

    // Tampilkan bagian detail asesi
    document.getElementById('detailIA03').classList.remove('hidden');

    // Optional: scroll ke bagian detail
    document.getElementById('detailIA03').scrollIntoView({ behavior: 'smooth' });
}
</script>
