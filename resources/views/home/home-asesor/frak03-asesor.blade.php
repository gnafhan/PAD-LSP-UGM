...
document.addEventListener('DOMContentLoaded', function () {
        ...
        try {
            ...
            if (result.success && result.data) {
                ...
                asesisData.forEach((asesi, index) => {
                    asesi.ak03_completed = progresses[index]?.progress_asesmen?.ak03?.completed || false;
                });
    ...
    function renderAsesiTable(asesisData) {
        ...
        asesisData.forEach((asesi, index) => {
            ...
            // [MODIFIED] Create a link to the detail page
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex justify-center items-center gap-2">
                            <a href="${detailUrl}">
                                <svg class="w-6 h-6 text-biru hover:text-ungu" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <a href="${detailUrl}">
                                <svg class="w-6 h-6 text-ungu hover:text-biru" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
