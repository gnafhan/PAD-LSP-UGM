    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden md:flex items-center justify-center flex-1 px-8">
                <div class="flex items-center space-x-1">
                    ...
                    <a href="{{ route('user.persetujuan.index') }}" 
                       class="nav-link {{ request()->routeIs('user.persetujuan.index') ? 'nav-link-active' : '' }}">
                        Daftar Sertifikasi
                    </a>
                </div>
            </div>
        ...
        <div class="md:hidden" 
            ...
            <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100 rounded-b-lg shadow-large">
                ...
                <a href="{{ route('user.persetujuan.index') }}" 
                   class="mobile-nav-link {{ request()->routeIs('user.persetujuan.index') ? 'mobile-nav-link-active' : '' }}"
                   @click="mobileMenuOpen = false">
                    Daftar Sertifikasi
                </a>
