...
@section('content')
    ...
    <div class="flex flex-wrap gap-2">
        <a href="/home" class="bg-black hover:bg-gray-400 text-white px-2 py-1 rounded text-sm md:text-base flex-shrink-0">Kembali</a>
        ...
        <a href="/apl/2" id="btn-selanjutnya" class="bg-blue-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-700">Selanjutnya</a>
        </div>
        </div>
    </div>
    </div>
