...
<body class="bg-cover bg-center h-screen flex items-center justify-center" style="background-image: url('/images/bg.jpg');">
    ...
    <div class="relative bg-white bg-opacity-90 shadow-lg rounded-lg p-8 max-w-sm w-full z-10">
        ...
        <!-- Login Buttons -->
        <a href="/loginasesi" class="w-full bg-indigo-600 text-white py-2 rounded-md font-semibold transition duration-300 transform hover:scale-105 shadow-lg mb-4 text-center block">
            <i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Asesi
        </a>
        <a href="/loginasesor" class="w-full bg-indigo-600 text-white py-2 rounded-md font-semibold transition duration-300 transform hover:scale-105 shadow-lg mb-4 text-center block">
            <i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Asesor
        </a>
        <a href="/loginadmin" class="w-full bg-indigo-600 text-white py-2 rounded-md font-semibold transition duration-300 transform hover:scale-105 shadow-lg mb-4 text-center block">
