...
<body class="bg-cover bg-center h-screen flex items-center justify-center" style="background-image: url('/images/bg.jpg');">
    ...
    <div class="relative bg-white bg-opacity-90 shadow-lg rounded-lg p-8 max-w-sm w-full z-10">
        ...
        <!-- New Password Field -->
        <div class="mb-4">
            <label for="username" class="block text-sm font-medium text-gray-700 mb-2">New Password</label>
            <input type="text" id="new-password" placeholder="Enter New Password..."
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        </div>
        <!-- Confirm Field -->
        <div class="mb-4">
            <label for="username" class="block text-sm font-medium text-gray-700 mb-2">Confirm Password</label>
