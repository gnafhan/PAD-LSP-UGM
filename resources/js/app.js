...
class ActiveStateManager {
    ...
    updateActiveStates() {
        ...
        const currentRoute = this.routeMap[currentPath] || this.getRouteFromPath(currentPath);
    ...
    getRouteFromPath(path) {
        ...
        if (path === '/asesi/jadwal-uji-kompetensi') return 'asesi.jadwal-uji-kompetensi';
...
class PageTransitionManager {
    ...
    async enterTransition() {
        ...
        return new Promise((resolve) => {
            ...
            mainContent.classList.remove('page-transition-out', 'page-transition-enter');
...
class FooterNewsletterHandler {
    ...
    async handleNewsletterSubmit(form) {
        ...
        if (!this.isValidEmail(emailInput.value)) {
            this.showMessage('Mohon masukkan alamat email yang valid.', 'error');
            return;
        }
        ...
        try {
            ...
            this.showMessage('Terima kasih! Anda telah berhasil berlangganan newsletter kami.', 'success');
            emailInput.value = '';
