...
//        @dd($generalInfo);
        ...
        if ($mapa02) {
            ...
            $hasilItems = $mapa02->hasilItems()->pluck('hasil_item')->toArray();

            return view('home.home-asesor.frmapa02-pdf', [
                'generalInfo' => $generalInfo,
                'mapa02' => [
                    'hasil_yang_akan_dikumpulkan' => $hasilItems,
                    'waktu_tanda_tangan_asesi' => DateTimeHelper::toWIB($mapa02->waktu_tanda_tangan_asesi),
                    'tanda_tangan_asesi' => $mapa02->waktu_tanda_tangan_asesi ? $asesi->ttd_pemohon = asset('storage/' . $asesi->ttd_pemohon) : null,
                    'waktu_tanda_tangan_asesor' => DateTimeHelper::toWIB($mapa02->waktu_tanda_tangan_asesor),
            ...
            return view('home.home-asesor.mapa02-pdf', [
                'generalInfo' => $generalInfo,
                'record_exists' => false
            ]);
        }
