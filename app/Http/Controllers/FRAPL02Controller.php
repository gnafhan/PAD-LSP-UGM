...
//        @dd($asesor);
        ...
        $frapl02 = Apl02::where('id_asesi', $asesi->id_asesi)
            ->first();
        ...
        if ($frapl02) {
            ...
            $tandaTanganAsesor = $asesor->getTandaTanganPadaWaktu($frapl02->waktu_tanda_tangan_asesor);
            ...
            $hasilItems = $frapl02->hasilItems()->pluck('hasil_item')->toArray();
            ...
            return view('home.home-asesor.frak01-pdf', [
                ...
                'data' => [
                    ...
                    'ak01' => [
                        ...
                        'waktu_tanda_tangan_asesi' => DateTimeHelper::toWIB($frapl02->waktu_tanda_tangan_asesi),
                        'tanda_tangan_asesi' => $frapl02->waktu_tanda_tangan_asesi ? $asesi->ttd_pemohon = asset('storage/' . $asesi->ttd_pemohon) : null,
                        'waktu_tanda_tangan_asesor' => DateTimeHelper::toWIB($frapl02->waktu_tanda_tangan_asesor),
            ...
            return view('home.home-asesor.frapl02-pdf', [
